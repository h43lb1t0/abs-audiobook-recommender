    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-brand-card p-6 rounded-md shadow-sm">
      ...
      <div class="flex flex-col items-end gap-2">
        <button @click="refreshRecommendations" :disabled="loading" 
          class="flex items-center gap-2 bg-brand-primary hover:bg-green-600 text-white px-6 py-3 rounded-md font-bold transition-colors shadow-sm disabled:opacity-70 disabled:cursor-not-allowed">
